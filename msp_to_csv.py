...
#file to be parsed
msp_file_object=open('/home/rictuar/coding_projects/fiehn_work/text_files/nist20_hr_msms_nist.MSP','r')

#file to be written to
#append mode
csv_file_object=open('/home/rictuar/coding_projects/fiehn_work/text_files/nist20_hr_csv.txt','a')

#add headers to csv file
for header in nist_20_headers:
...
#start
isolate_spectra(nist_20_headers)